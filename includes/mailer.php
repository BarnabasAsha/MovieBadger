...
if (isset($email)) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
        ...
        $body = '
        <div class="mail-container" style="background: linear-gradient(81.7deg, #1A2632 35.21%, #F0324F 116.87%); color: white; padding: 30px; text-align: center; width: 280px; height: 200px; margin: auto; font-family: sans-serif;">
